...
import com.catanatron.core.models.CatanMap;
...
public class GameState {
  ...
  // Number of resources each player (by color index) still must discard this round
  ...
  public GameState(
    ...
    this.discardCounts = new int[colors.length];
  ...
  public GameState copy() {
    ...
    c.discardCounts = discardCounts.clone();
